...
test('correct task should be added to correct array', () => {
    ...
    const action = taskActions.addTaskAC({
        task: {
...
test('title of specified task should be changed', () => {
    const action = taskActions.updateTaskAC({taskId: "2", model: {title: "yogurt"}, todolistId: "todolistId2"});
...
test('empty arrays should be added when we set todolists', () => {
        const action = todolistActions.setTodoListsAC({
            todolists: [
